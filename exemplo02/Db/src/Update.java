...
public class Update {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            preparedStatement.setString(1, "Carlos"); // Substitua "NovoNome" pelo valor desejado
            preparedStatement.setInt(2, 4); // Substitua 50 pelo ID do registro a ser atualizado
